...
namespace FeedbackMe.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("FeedbackMe-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/FeedbackMe.Web")]
    ...
    /// <summary>
    /// The DomainContext corresponding to the 'FeedbackService' DomainService.
    /// </summary>
    public sealed partial class FeedbackContext : DomainContext
    {
        ...
        public FeedbackContext() : 
                this(new WebDomainClient<IFeedbackServiceContract>(new Uri("FeedbackMe-Web-FeedbackService.svc", UriKind.Relative)))
        {
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedbackContext"/> class with the specified service URI.
        /// </summary>
        /// <param name="serviceUri">The FeedbackService service URI.</param>
        public FeedbackContext(Uri serviceUri) : 
                this(new WebDomainClient<IFeedbackServiceContract>(serviceUri))
        {
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedbackContext"/> class with the specified <paramref name="domainClient"/>.
        /// </summary>
        /// <param name="domainClient">The DomainClient instance to use for this DomainContext.</param>
        public FeedbackContext(DomainClient domainClient) : 
                base(domainClient)
        {
            this.OnCreated();
        }
        ...
        /// <summary>
        /// Gets the set of <see cref="feedback"/> entity instances that have been loaded into this <see cref="FeedbackContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the set of <see cref="Lecturer"/> entity instances that have been loaded into this <see cref="FeedbackContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the set of <see cref="module"/> entity instances that have been loaded into this <see cref="FeedbackContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the set of <see cref="student"/> entity instances that have been loaded into this <see cref="FeedbackContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the set of <see cref="user"/> entity instances that have been loaded into this <see cref="FeedbackContext"/> instance.
        /// </summary>
        public EntitySet<user> users
        {
            get
        ...
        protected override EntityContainer CreateEntityContainer()
        {
            return new FeedbackContextEntityContainer();
        }
        
        /// <summary>
        /// Service contract for the 'FeedbackService' DomainService.
        /// </summary>
        [ServiceContract()]
        public interface IFeedbackServiceContract
        {
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/FeedbackService/GetFeedbacksDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/FeedbackService/GetFeedbacks", ReplyAction="http://tempuri.org/FeedbackService/GetFeedbacksResponse")]
            [WebGet()]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/FeedbackService/GetLecturersDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/FeedbackService/GetLecturers", ReplyAction="http://tempuri.org/FeedbackService/GetLecturersResponse")]
            [WebGet()]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/FeedbackService/GetModulesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/FeedbackService/GetModules", ReplyAction="http://tempuri.org/FeedbackService/GetModulesResponse")]
            [WebGet()]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/FeedbackService/GetStudentsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/FeedbackService/GetStudents", ReplyAction="http://tempuri.org/FeedbackService/GetStudentsResponse")]
            [WebGet()]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/FeedbackService/GetUsersDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/FeedbackService/GetUsers", ReplyAction="http://tempuri.org/FeedbackService/GetUsersResponse")]
            [WebGet()]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/FeedbackService/SubmitChangesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/FeedbackService/SubmitChanges", ReplyAction="http://tempuri.org/FeedbackService/SubmitChangesResponse")]
            IAsyncResult BeginSubmitChanges(IEnumerable<ChangeSetEntry> changeSet, AsyncCallback callback, object asyncState);
        ...
        internal sealed class FeedbackContextEntityContainer : EntityContainer
        {
            
            public FeedbackContextEntityContainer()
            {
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("FeedbackMe-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
